        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-sm">
                At ePharmacy, we are committed to providing convenient and reliable healthcare products online.
                Our goal is to offer a seamless and secure shopping experience.
              </p>
            </div>
            ...
            <div>
              ...
              <ul>
                ...
                <li><a href="#offer" className="text-sm hover:underline">What We Offer</a></li>
            ...
            <div>
              ...
              <p className="text-sm">Email: support@epharmacy.com</p>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm">
              &copy; 2024 ePharmacy. All rights reserved. | Designed by Your Company
            </p>
          </div>
        </div>
      </footer>
